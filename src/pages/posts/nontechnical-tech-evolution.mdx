...
This website was the first real website I ever made using my new and first computer. It was also the first website I ever made with <Tag name="vue"/>.
